...
--
-- Этот файл только создаёт таблицы в облаке. Код приложения
-- (src/**) его не использует — localStorage-адаптер продолжает
-- работать как раньше, миграция данных сюда не входит.
-- ============================================================
